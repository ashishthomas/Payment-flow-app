...
const NewsPage = () => {
  ...
  const newsArticles = [
    ...
    {
      id: 10,
      title: "FlowPay Expands to Southeast Asia",
      category: "Company News",
      date: "2023-01-31",
      author: "Ananya Rao",
      excerpt:
        "We’re thrilled to announce our expansion into Singapore, Malaysia, and Indonesia—bringing seamless digital payments to new markets.",
      image:
        "https://images.pexels.com/photos/3228686/pexels-photo-3228686.jpeg?auto=compress&cs=tinysrgb&w=800",
      readTime: "5 min read",
    },
  ];
